...
if __name__ == "__main__":
    ...
    parser.add_argument( '--model_name', type=str, default='SigRelayST_V1_Human_Lymph_Node_spatial', help='Name of the trained model', required=True)
...
##################### get metadata: barcode_info ###################################
    ...
    for l in [3,2]: #, 3]: # 2 = layer 2, 3 = layer 1 
        ...
        for run_time in range (start_index, start_index+total_runs):
            ...
            X_attention_filename = args.embedding_path +  args.model_name + filename_suffix + 'attention.gz' #.npy
